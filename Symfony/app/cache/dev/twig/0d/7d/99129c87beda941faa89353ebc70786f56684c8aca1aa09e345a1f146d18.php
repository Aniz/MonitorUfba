...
/* BdMonitorUfbaBundle:Projetodemonitoria:index.html.twig */
class __TwigTemplate_0d7d99129c87beda941faa89353ebc70786f56684c8aca1aa09e345a1f146d18 extends Twig_Template
{
    ...
    {
        // line 4
        echo "<h1>Projetodemonitoria list</h1>
    ...
    <table class=\"records_list\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["entity"]) {
            ...
            echo "            <tr>
                <td><a href=\"";
            // line 27
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("projeto_show", array("id" => $this->getAttribute($this->getContext($context, "entity"), "id"))), "html", null, true);
            echo "\">";
            ...
            echo "</td>
                <td>";
            // line 36
            if ($this->getAttribute($this->getContext($context, "entity"), "periodoInscricaoInicio")) {
            ...
            echo "</td>
                <td>";
            // line 37
            if ($this->getAttribute($this->getContext($context, "entity"), "periodoInscricaoFinal")) {
            ...
            echo "</td>
                <td>";
            // line 38
            if ($this->getAttribute($this->getContext($context, "entity"), "periodoSelecao")) {
    ...
    {
        return "BdMonitorUfbaBundle:Projetodemonitoria:index.html.twig";
    }
