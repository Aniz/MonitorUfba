...
/* BdMonitorUfbaBundle:Relatorio:index.html.twig */
class __TwigTemplate_e27539bc38a38c307c52b41d498e494771fc54aed894b5d47ffee3eda54e2a18 extends Twig_Template
{
    ...
    <table class=\"records_list\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["entity"]) {
            ...
            echo "            <tr>
                <td><a href=\"";
            // line 17
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("relatorio_show", array("id" => $this->getAttribute($this->getContext($context, "entity"), "id"))), "html", null, true);
            echo "\">";
        ...
        <li>
            <a href=\"";
        // line 36
        echo $this->env->getExtension('routing')->getPath("relatorio_new");
        echo "\">
                Create a new entry
            </a>
        </li>
    ...
    {
        return "BdMonitorUfbaBundle:Relatorio:index.html.twig";
    }
