...
use Bd\MonitorUfbaBundle\Entity\Departamento;
use Bd\MonitorUfbaBundle\Form\DepartamentoType;
...
class DepartamentoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('BdMonitorUfbaBundle:Departamento')->findAll();
     ...
     * @Method("POST")
     * @Template("BdMonitorUfbaBundle:Departamento:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('BdMonitorUfbaBundle:Departamento')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("BdMonitorUfbaBundle:Departamento:edit.html.twig")
     */
