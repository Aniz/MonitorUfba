...
use Bd\MonitorUfbaBundle\Entity\Pessoa;
use Bd\MonitorUfbaBundle\Form\PessoaType;
...
class PessoaController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('BdMonitorUfbaBundle:Pessoa')->findAll();
     ...
     * @Method("POST")
     * @Template("BdMonitorUfbaBundle:Pessoa:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('BdMonitorUfbaBundle:Pessoa')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("BdMonitorUfbaBundle:Pessoa:edit.html.twig")
     */
